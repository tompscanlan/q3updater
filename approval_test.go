...
func CompareApproval(a *Approval, b *Approval, t *testing.T) {
	...
	if a.Id != b.Id {
		t.Errorf("expected %s, got %s", a.Id, b.Id)
	}

	if a.TeamId != b.TeamId {
		t.Errorf("expected %s, got %s", a.TeamId, b.TeamId)
	}

	if a.Blob != b.Blob {
		t.Errorf("expected %s, got %s", a.Blob, b.Blob)
	}
	if a.Description != b.Description {
		t.Errorf("expected %s, got %s", a.Description, b.Description)
	}
	if a.Approved != b.Approved {
		t.Errorf("expected %s, got %s", a.Approved, b.Approved)
	}
}
